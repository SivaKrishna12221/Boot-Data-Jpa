...
public class Doctor {
	@Column(name = "doctorid") // here also name is case sensitive but it should not be changed because it is a
								// primary key
	@Id
	...
	@Column(name = "doctorname", length = 25) // IF we change name new column will generate
	private String name;
